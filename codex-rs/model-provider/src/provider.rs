...
use crate::llama_cpp_models_endpoint::LlamaCppModelsEndpoint;
use crate::models_endpoint::OpenAiModelsEndpoint;
use crate::ollama_models_endpoint::OllamaModelsEndpoint;
            ...
            None => {
                let endpoint: Arc<dyn codex_models_manager::manager::ModelsEndpointClient> =
                    if self.info.name == "gpt-oss" {
                        Arc::new(OllamaModelsEndpoint::new(self.info.base_url.clone()))
                    } else if self.info.name == "llama_cpp" {
                        Arc::new(LlamaCppModelsEndpoint::new(self.info.base_url.clone()))
                    } else {
